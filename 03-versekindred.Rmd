...
suppressWarnings(finalResultsBB3SeeDev %>%
  dplyr::mutate_all(linebreak) %>%
  knitr::kable(
    booktabs = TRUE, escape=FALSE,
...
suppressWarnings(kindredBB3 %>%
  knitr::kable(
    booktabs = TRUE, escape=FALSE,
    caption = 'Cross-validated results (Fold1/Fold2) and final test set results for Kindred predictions in Bacteria Biotope (BB3) event subtask with test set results for the top three performing tools: VERSE, TurkuNLP and LIMSI.',
